 ...
 * This file demonstrates how to integrate Stageurn with a web frontend
 */

// For React/Vue/Angular applications
export class StageurnClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new StageurnClient(provider, contractAddress);
